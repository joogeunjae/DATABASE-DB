...
VALUES('jiraynor@naver.com', sha2('P!ssw0rd', 512), 'jiraynor',
 '010-1111-2222', '부산 광역시', '부산진구', true);

-- 로그인
-- 패스워드 암호화가 되어있지 않을때 이렇게 작업
SELECT * FROM USER
...
-- 게시물 작성
INSERT INTO Board(title, content, board_image_url, writer_datetime, writer_email)
...
-- 주간 TOP3 리스트
SELECT * FROM Board_View
WHERE write_dateime >= '2023-03-27'
...
-- 내 게시물 리스트
SELECT * FROM Board_View
WHERE writer_email = 'jiraynor@naver.com';

-- 좋아요
INSERT INTO Liky(user_email, board_number)
VALUES('jiraynor@naver.com', 1);

-- 좋아요 취소
DELETE FROM Liky
WHERE user_email = 'jiraynor@naver.com'
AND board_number = 1;

-- 댓글 작성
INSERT INTO Comment(user_email, board_number, comment_content, write_date)
VALUES('jiraynor@naver.com', 1, 'Test Comment', now());
